[_tb_system_call storage=system/_scene_1_2.ks]
...
[chara_new name="ダミー" color="0x202020"  storage="chara/6/ひいろ_ダミー_仮.png"  jname=&f.name1]
#ダミー
（そんなことを考えていたら、青野さんが横からピョンと顔を覗き込んできた）[p]
[_tb_end_text]

[chara_show  name="青野"  face="普通"  time="10"  wait="true"  width="550"  height="1080"  left="205"  top="-45"  reflect="false"  ]
[tb_start_text mode=4 ]
[cm]
...
[chara_hide  name="青野"  time="1"  wait="true"  pos_mode="false"  ]
...
[ptext name="name_area" layer="message0" color="0x000000" x="15" y="410" overwrite="true"]
#ちぐさ
[ruby text="こう"]黄[ruby text="せん"]泉[ruby text="ちょう"]町に伝わる、[ruby text="こう"]黄[ruby text="せん"]泉[ruby text="えい"]英[ruby text="ゆう"]雄[ruby text="でん"]伝[ruby text="せつ"]説になぞらえたお祭りなんだよぉ[p]
[_tb_end_text]
