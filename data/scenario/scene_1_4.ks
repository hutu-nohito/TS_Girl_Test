[_tb_system_call storage=system/_scene_1_4.ks]
...
[playbgm  volume="80"  time="1000"  loop="true"  storage="uwasa.mp3"  fadein="true"  ]
[iscript]
f.name1="<center><p>"+f.last_name+f.first_name+"</p></center>"
[endscript]
...
だって、ボクの占いによると、
&f.nick_name_yuuma
は「今月気になる子にアプローチすると恋人ができる」って出てるんだもん〜[p]
[_tb_end_text]
